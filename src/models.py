...
class AppBasicChoice(models.Model):
    id = models.BigAutoField(primary_key=True)
    choice_text = models.CharField(max_length=200)
    votes = models.IntegerField()
    question = models.ForeignKey('AppBasicQuestion', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'app_basic_choice'


class AppBasicQuestion(models.Model):
    id = models.BigAutoField(primary_key=True)
